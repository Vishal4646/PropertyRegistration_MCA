...
import com.database.ConnectionManager;
        ...
        public class SimpleCryptoAndroidJava {
                ...
                public byte[] encryptNew(String text, String key) throws Exception
                {
                        ...
                        byte[] encrypted = null;
                        SecretKeySpec keyspecNew = new SecretKeySpec(padString(key).getBytes(), "AES");
                        try {
                ...
                public byte[] encryptNewByte(byte[] text, String key) throws Exception
                {
                        if(text == null || text.length == 0)
                                throw new Exception("Empty string");
...
//                                throw new Exception("[encrypt] " + e.getMessage());
                ...
                public byte[] decryptNewByte(String code,String key) throws Exception
                {
                        if(code == null || code.length() == 0)
                                throw new Exception("Empty string");
                ...
                public static String decryptStringNew(String enc,String key) throws Exception{
                	SimpleCryptoAndroidJava mc=new SimpleCryptoAndroidJava();
                	byte decrypted[];
                ...
                public static void main(String[] args) {
                	try {
						String pass = SimpleCryptoAndroidJava.decryptString("2168819d81d1c8a445512461c97034bb");
                ...
                public static void main1(String[] args) {
					...
					try {
						...
						//System.out.println(decryptString("a0ecd65953d3c2d5d73cfb684fae8e2c"));

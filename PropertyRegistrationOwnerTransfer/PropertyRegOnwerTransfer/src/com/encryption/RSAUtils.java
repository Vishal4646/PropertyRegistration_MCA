...
public class RSAUtils {
	...
	public static void main(String[] args) {
		RSAUtils obj = new RSAUtils();
		try {
			String [] a = obj.getNewKeyPair();
			String [] b = obj.getNewKeyPair();
			
			//String EncResult2 = encryptUsingPublic("Hello", b[0]);
			String EncResult1 = encryptUsingPrivate("Hello", a[1]);
			
			String DecResult2 = decryptUsingPublic(EncResult1, a[0]);
			//String DecResult1 = decryptUsingPrivate(EncResult2, b[1]);

 ...
 * Generated at: 2022-07-21 06:40:33 UTC
...
public final class buyProperty_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h4 class=\"page-title\">Buy Properties</h4>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Request to View</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
...
String isacc = ConnectionManager.isPropReqAccepted(dm.getDid(), um.getUid()); 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td><a href=\"javascript:fnRequestToView('");
      out.print(dm.getDid());
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(um.getUid());
      out.write("');\">Request Details</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
}else{ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-success\">Request Accepted</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
} 
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function fnRequestToView(did,uid){\r\n");
      out.write("\r\n");
      out.write("\t$.post(\"");
      out.print(request.getContextPath());
      out.write("/tiles/ajax.jsp?methodId=fnRequestToView&did=\"+did+\"&uid=\"+uid,\r\n");
      out.write("\t\t\t function(data) {\r\n");
      out.write("\t\t\t\tif(data==\"0\"){\r\n");
      out.write("\t\t\t\t\talert(\"Some Problem Occurred!\");\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\talert(\"Request sent to owner!\");\r\n");
      out.write("\t\t\t\t\t//window.location.href=\"");
      out.print(request.getContextPath());
      out.write("/pages/dashboard.jsp\";\r\n");

 ...
 * Generated at: 2022-07-15 04:20:33 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"card-title\">Add Property</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tReg. Document:<BR> <input class=\"btn btn-default \"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\taccept=\"application/pdf\" required=\"required\" type=\"file\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"file\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 70%; background-color: #ffffff; border: 1px solid #8a8a8a;\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<br>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\tProperty ID: -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"propid\" placeholder=\"Property ID\"\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\tSurvey No.: -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"surveyno\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Survey No.\" required=\"required\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control btn-default\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 70%; background-color: #ffffff; border: 1px solid #8a8a8a; margin-bottom: 15px\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\tProperty Type.: -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"proptype\" -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Property Type\" required=\"required\" -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control btn-default\" -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 70%; background-color: #ffffff; border: 1px solid #8a8a8a; margin-bottom: 15px\"> -->\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<select class=\"form-control btn-default\" name=\"proptype\" required=\"required\" placeholder=\"Property Type\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 70%; background-color: #ffffff; border: 1px solid #8a8a8a; margin-bottom: 15px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option selected disabled>Property Type</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option>Land</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option>House</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option>Shop</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option>Apartment</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option>Farm</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\tProperty Area: -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"proparea\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Area(sq.ft.)\" required=\"required\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control btn-default\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 70%; background-color: #ffffff; border: 1px solid #8a8a8a; margin-bottom: 15px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<BR>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<BR>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\tAddress: -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea type=\"text\" name=\"addr\" placeholder=\"Address\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired=\"required\" class=\"form-control btn-default\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 70%; background-color: #ffffff; border: 1px solid #8a8a8a; margin-bottom: 15px\"></textarea>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\tCity: -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t<input  type=\"text\" name=\"propcity\" placeholder=\"City\" -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\trequired=\"required\" class=\"form-control btn-default\" -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 70%; background-color: #ffffff; border:1px solid #8a8a8a; margin-bottom: 15px\"></input> -->\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tPrevious Owner Details :<BR class=\"mt-1\"> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"text\" name=\"preownername\" placeholder=\"Full Name\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired=\"required\" class=\"form-control btn-default mt-3\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"width: 70%; background-color: #ffffff; border: 1px solid #8a8a8a; margin-bottom: 15px\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- \t\t\t\t\t\t\t\t\t\t\t\t\t\tAddress: -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea type=\"text\" name=\"preowneraddr\"\r\n");

 ...
 * Generated at: 2022-08-03 14:12:22 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h4 class=\"page-title\">Verified Properties</h4>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Make Available<br>for Sale</th>\r\n");
...
if(dm.getSale().equalsIgnoreCase("Y")){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td><a href=\"javascript:fnChangeSaleStat('N','");
      out.print(dm.getDid());
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(dm.getStatus());
      out.write("');\">Make Un-available<br>for Sale</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
}else{ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td><a href=\"javascript:fnChangeSaleStat('Y','");
      out.print(dm.getDid());
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(dm.getStatus());
      out.write("');\">Make Available<br>for Sale</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
} 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");

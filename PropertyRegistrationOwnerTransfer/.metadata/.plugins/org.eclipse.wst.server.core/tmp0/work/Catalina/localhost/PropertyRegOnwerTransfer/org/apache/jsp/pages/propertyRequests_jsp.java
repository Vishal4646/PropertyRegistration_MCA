 ...
 * Generated at: 2022-07-15 04:26:58 UTC
...
public final class propertyRequests_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.model.PropertyViewRequestModel");
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h4 class=\"page-title\">Property Requests</h4>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<h5>Incoming Requests</h5>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Requested From</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Adhar</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Email</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Mobile</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Accept Request</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Reject Request</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write(".</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td ><i style=\"font-size: 15px;\"></i> ");
      out.print(dm.getProptype());
      out.write("</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(dm.getReqfrom());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(dm.getAdhar());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(dm.getEmail());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(dm.getMobile());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
if(dm.getStat().equalsIgnoreCase("Y")){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-primary\">Accepted</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
}else{ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\"><a class=\"text-success\" href=\"javascript:fnAccRejRequest('1',");
      out.print(dm.getReqid());
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\"><a class=\"text-danger\" href=\"javascript:fnAccRejRequest('0',");
      out.print(dm.getReqid());
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<h5>No Any Incoming Requests Yet</h5>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
}
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t<div class=\"row row-card-no-pd mt-4 pt-4\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"card card-tasks\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"card-body \">\r\n");
      out.write("\t\t\t\t\t\t\t\t<h5>Accepted Requests</h5>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"table-full-width\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<table class=\"table\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<tr style=\"text-align: center\">\r\n");
 ...
 String da = dm.getCurrenttimedate();
      ...
      out.print(da);
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"left\" style=\"color: #59d05d\">Verified</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td></i>");
      out.print(dm.getAddr());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(dm.getRegistrar());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<h5>No Any Accepted Requests Yet</h5>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
}
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function fnAccRejRequest(stat,reqid){\r\n");
      out.write("\r\n");
      out.write("\t$.post(\"");
      out.print(request.getContextPath());
      out.write("/tiles/ajax.jsp?methodId=changeRequestStat&stat=\"+stat+\"&reqid=\"+reqid,\r\n");
      out.write("\t\t\t function(data) {\r\n");
      out.write("\t\tdata = $.trim(data);\r\n");
      out.write("\t\tconsole.log(\"received data: \" + data);\r\n");
      out.write("\t\t\t\tif(data==\"1\"){\r\n");
      out.write("\t\t\t\t\talert(\"Request Accepted!\");\r\n");
      out.write("\t\t\t\t\tlocation.reload(); \r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\talert(\"Request Rejected!\");\r\n");
      out.write("\t\t\t\t\t//window.location.href=\"");
      out.print(request.getContextPath());
      out.write("/pages/dashboard.jsp\";\r\n");
      out.write("\t\t\t\t\tlocation.reload(); \r\n");
